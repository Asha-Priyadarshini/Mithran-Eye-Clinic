...
// Input
export const Input = ({type, name, onChange, value, className, disabled, placeholder}) => (
  <input type={type} id={name} name={name} value={value} placeholder={placeholder} className={`${className} font-medium`} disabled={disabled} onChange={onChange} required />
);